...
namespace Bitzy.Projectiles
{
	// Code adapted from the vanilla's magic missile.
	public class BitzyMissileProj : ModProjectile
	{
		...
		public override void AI() {
			...
			Dust dust = Dust.NewDustPerfect(dustPosition, DustType<BitzyDust>(), null, 100, Color.White, 0.8f);
			dust.velocity *= 0.3f;
			dust.noGravity = true;
