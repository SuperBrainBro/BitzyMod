...
namespace Bitzy.NPCs
{
	public class BitzyGlobalNPC : GlobalNPC
	{
		...
		public void dropBitzySoul(int chance, NPC npc)
		{
			if (Main.rand.Next(chance) == 0)
				Item.NewItem(npc.getRect(), ItemType<BitzySoul>(), 1 + Main.rand.Next(2)); // 1 or 2
		}
